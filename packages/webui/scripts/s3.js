...
if (!BUCKETNAME) {
  console.log("☢️   Enter a bucket name in packages/webui/scripts/s3.js ");
  process.exit(1);
}
...
try {
  ...
  console.log(e);
  console.log(
    '☢️   Create an aws.json credentials file in packages/webui/ like { "accessKeyId": "xxx", "secretAccessKey": "xxx", "region": "xxx" } ',
  );
  process.exit(1);
}
